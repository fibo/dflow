...
export declare type DflowValue = string | number | boolean | null | undefined | DflowArray | DflowObject | DflowSerializableGraph;
...
export declare class DflowNode extends DflowItem {
    ...
    static isDflowNode({ kind, inputs, outputs, ...item }: DflowSerializableNode): boolean;
    constructor({ kind, inputs, outputs, ...item }: DflowSerializableNode, host: DflowHost, { isAsync, isConstant, label }?: DflowNodeMetadata);
    get label(): string;
...
export declare class DflowEdge extends DflowItem {
    ...
    static isDflowEdge({ source, target, ...item }: DflowSerializableEdge, graph: DflowSerializableGraph): false | DflowSerializableNode | undefined;
...
export declare class DflowGraph extends DflowItem {
    ...
    private static childrenOfNodeId;
    private static parentsOfNodeId;
    private static levelOfNodeId;
    private static ancestorsOfNodeId;
    /**
